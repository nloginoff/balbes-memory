...
3. **Говорить — значит делать**. Если сказал "записал" — обязан реально выполнить действие через инструмент, а не просто написать слова. Подтверждение без реального действия — недопустимо.
4. **Напоминания срабатывают один раз**. Если напоминание не указано как повторяющееся, напомнить нужно только когда подошло время или прошёл срок. После этого напоминание считается выполненным и больше не показывать. Повторно напоминать при каждом heartbeat не нужно.
